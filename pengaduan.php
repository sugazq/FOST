...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
          ...
          <span class="brand-text font-weight-light">SiPeKa</span>
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="data_tanggapan_mahasiswa.php" class="nav-link">Tanggapan</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                      ...
                      $no = 1;
                      include "koneksi.php";
                      $mahasiswa    =mysqli_query($koneksi, "SELECT * FROM mahasiswa where username='$_SESSION[username]'");
                      while($d = mysqli_fetch_array($mahasiswa)){
                        $pengaduan    =mysqli_query($koneksi, "SELECT * FROM pengaduan where nim='$d[nim]'");
                        while($d_pengaduan = mysqli_fetch_array($pengaduan)){
                          ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($d_pengaduan['status'] == 'menunggu') { ?>
                                                ...
                                                <td>
                                                    <a href="" class="btn btn-info btn-sm" data-toggle="modal"
                                                        data-target="#modal-edit<?=$d_pengaduan['id_pengaduan']?>"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="hapus_pengaduan.php?id_pengaduan=<?php echo $d_pengaduan['id_pengaduan']; ?>"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="update_pengaduan.php"
                                                                enctype="multipart/form-data">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Isi Laporan</label>
                                                                        <input type="text" name="id_pengaduan"
                                                                            value="<?=$d_pengaduan['id_pengaduan']?>"
                                                                            hidden>
                                                                        <input type="text" name="nim"
                                                                            value="<?=$d_pengaduan['nim']?>" hidden>
                                                                        <textarea class="form-control"
                                                                            name="isi_laporan" rows="3"
                                                                            placeholder="Enter ..."><?=$d_pengaduan['isi_laporan']?></textarea>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Foto Pengaduan</label>
                                                                        <img src="upload/<?=$d_pengaduan['foto']?>"
                                                                            width="100">
                                                                        <input type="file" name="foto"
                                                                            class="form-control">
                                                                        <i
                                                                            style="float: left;font-size: 11px;color: red">Abaikan
                                                                            jika tidak merubah foto pengaduan</i>
                                                                    </div>
                                                                </div>
                                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="simpan_pengaduan.php"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label>Isi Laporan</label>
                                                        <input type="text" name="nim" value="<?=$d['nim']?>" hidden>
                                                        <textarea class="form-control" name="isi_laporan" rows="3"
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy;  <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
