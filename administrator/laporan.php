    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Laporan Sistem Pengaduan Warga Informatika</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card card-warning card-outline">
                <div class="card-header">
                  ...
                  <a href="print.php" class="btn btn-warning btn-sm float-end"><i class="fas fa-print"></i> Print Laporan</a>   
                    ...
                    <?php
                      ...
                      include "../koneksi.php";
                        ...
                        if( isset($_POST['cari'])) {
                          ...
                          $q = "SELECT * FROM tanggapan INNER JOIN pengaduan ON tanggapan.id_pengaduan = pengaduan.id_pengaduan INNER JOIN petugas ON tanggapan.id_petugas = petugas.id_petugas WHERE tanggapan like '%$keyword%' OR tgl_tanggapan like '%$keyword%' or
                                                                                                                                                                                                      isi_laporan like '%$keyword%' or tgl_pengaduan like '%$keyword%'
                      ...
                      while($d = mysqli_fetch_array($catatan)){
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <a><img src="../upload/<?=$d['foto']?>" width="100"></a><br>
